...
class App:
    def __init__(self, master):
        ...
        self.om_graphtype_var.trace("w", self.callback)
        ...
        self.lbl_nodeattrs = tk.Label(
            text="Which columns contain your node attributes?")
        ...
        self.lbl_nodeattrs.grid(row=6, column=0, sticky='nw', padx=5, pady=5)
        self.lbx_nodeattrs.grid(row=6, column=1, sticky='e', padx=5, pady=5)

        self.btn_close.grid(row=7, column=0, sticky='w', padx=5, pady=5)
        self.btn_run.grid(row=7, column=1, sticky='e', padx=5, pady=5)

        self.lbl_info.grid(row=8, column=0, columnspan=2,
